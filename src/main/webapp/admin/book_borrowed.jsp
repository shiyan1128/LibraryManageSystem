<%@ page language="java" contentType="text/html; meta charset=UTF-8" pageEncoding="UTF-8" %>
...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/pagination.js" charset="UTF-8"></script>
